...
$(".mobile-four .menu-toggle").hover(function() {
    ...
    if (menu === "close") {
		...
		$(this).parent().next(".mobile-nav").css("transition-delay", "0.5s
		menu = "open";
    } else {
      	$(this).parent().next(".mobile-nav").css("transform", "translate(0, -999%)");
		$(this).parent().next(".mobile-nav").css("transition-duration", "0.5;
		$(this).parent().next(".mobile-nav").css("transition-delay", "0.5;
		menu = "close";
	}
});
});
